    ...
    const sectionsData: SectionData[] = useMemo(() => [
        {
            years: "2014",
            title: "Наше наследие",
            dcr: "Мы гордимся нашим опытом в производстве полотенец, который передаётся из поколения в поколение. Наше наследие – это качество и традиции, которые мы сохраняем, одновременно внедряя современные разработки, чтобы предлагать лучшие решения для вашего дома.",
        },
        {
            years: "2017",
            title: "Начало производства",
            dcr: "Компания Parisa Home, основанная в 2009 году под названием ООО Sam Rafoat Textile, начинала с производства плюша для местного рынка. С первых дней работы компания уделяла внимание качеству своей продукции, завоёвывая доверие клиентов.",
        },
        {
            years: "2020",
            title: "Время роста",
            dcr: "С годами наш бренд значительно расширился, превратившись из локального производителя в международного игрока на рынке. Мы постоянно улучшали технологии, расширяли ассортимент и завоёвывали доверие наших клиентов, предлагая не только практичные, но и стильные решения для дома.",
        },
        {
            years: "2021",
            title: "Новые горизонты",
            dcr: "Сегодня мы смотрим в будущее с амбициозными планами. Продолжая опираться на традиции, мы активно внедряем инновации, чтобы создавать продукты, которые отвечают потребностям современного мира. Новые технологии и устойчивое развитие – ключевые направления нашего дальнейшего роста.",
        },
    ], []);
